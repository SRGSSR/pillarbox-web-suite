...
`,o=document.createDocumentFragment();l.forEach(({name:i,description:n})=>{const a=document.createElement("li");a.innerHTML=`
    ...
    <div class="link-container">
      <a href="https://github.com/SRGSSR/pillarbox-web-suite/tree/main/packages/${i}#readme"
         class="github-link"
         title="See in Github"
         target="_blank">
        ${c}
  ...
  `,o.append(a)});document.getElementById("content").append(o);
