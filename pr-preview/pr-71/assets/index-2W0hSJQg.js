...
`,s=document.createDocumentFragment();l.forEach(({name:i,description:n})=>{const a=document.createElement("li");a.innerHTML=`
  ...
  `,s.append(a)});document.getElementById("content").append(s);
