...
class ThumbnailPreviewOverlay extends Component {
  ...
  initListeners() {
    ...
    progressControl.on(['mousemove', 'touchmove'], this.#onMove);
    progressControl.on(['mouseleave', 'touchcancel', 'touchend'], this.#onCancel);
  ...
  removeListeners() {
    ...
    progressControl.off(['mousemove', 'touchmove'], this.#onMove);
    progressControl.off(['mouseleave', 'touchcancel', 'touchend'], this.#onCancel);
