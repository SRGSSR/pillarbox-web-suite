...
class UserPreferences extends Component {
  ...
  */
   ...
   * @param {Boolean} enabled Whether this preference type is allowed
   *
   * @returns {*} The preference value if enabled, otherwise undefined
   */
  getAllowedPreferenceValue(preference, enabled) {
